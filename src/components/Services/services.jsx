        ...
        <div className="row">
            ...
            >
                  <div className="item-box">
                    ...
                    <div className="cont">
                      <h6>{t('services.compositeTitle')}</h6>
            ...
            >
                  <div className="item-box">
                    ...
                    <div className="cont">
                      <h6>{t('services.rootCanalTitle')}</h6>
                      <p>{t('')}</p>
                    <div className="btn-more">
                    <Link href="/services/root-canal-treatment">
                    <a className="simple-btn mt-3">
                      {t('services.rootCanalShortDesc')}
                    </a>
                    </Link>
                  </div>
                    </div>
        ...
        <div className="row mt-lg-4">
            ...
            >
                  <div className="item-box">
                    ...
                    <div className="cont">
                      <h6>{t('services.extractionTitle')}</h6>
            ...
            >
                  <div className="item-box">
                    ...
                    <div className="cont">
                      <h6>{t('services.bleachingTitle')}</h6>
